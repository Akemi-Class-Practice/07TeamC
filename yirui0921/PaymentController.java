...
import cteam.com.ex.model.entity.Transaction_HistoryEntity;
import cteam.com.ex.service.PaymentService;
import cteam.com.ex.service.TransactionHistoryService;
import cteam.com.ex.service.TransactionItemService;
...
//    	Transaction_HistoryEntity lastestTransactions = transactionHistoryService.getTransactionId(student.getStudentId());
//    	
//    	// transactoin_itemに保存
//    	Iterator<LessonEntity> ite2 = list.iterator();
//    	while(ite2.hasNext()) {
//    		LessonEntity element = ite2.next();
//    		transactionItemService.createTransactionHistory(lastestTransactions.getTransactionId(), 
//    				element.getLessonId());
//    	} 
//    	
